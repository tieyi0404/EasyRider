...
public class NewDataToast extends Toast{
	 ...
	 * @return
	 */
	public static NewDataToast makeText(Context context, CharSequence text, boolean isSound,int margionTop) {
        ...
        result.setGravity(Gravity.TOP, 0, (int)(dm.density*margionTop));
	...
	public static NewDataToast makeText(Context context, CharSequence text, boolean isSound) {
        ...
        result.setView(v);
        result.setDuration(600);
        result.setGravity(Gravity.TOP, 0, (int)(dm.density*55));
