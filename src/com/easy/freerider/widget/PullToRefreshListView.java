...
public class PullToRefreshListView extends ListView implements OnScrollListener {  
    ...
    public boolean onTouchEvent(MotionEvent event) {  
        ...
        case MotionEvent.ACTION_UP:  
        	System.out.println("harry --- ACTION_UP-" + event.getAction());
            if (state != REFRESHING) {  
                if (state == DONE) {  
        ...
        case MotionEvent.ACTION_MOVE:  
            ...
            if (state != REFRESHING && isRecored) {  
            	...
            	System.out.println("harry --- 可以松开刷新了-" + state);
    ...
    private void changeHeaderViewByState() {  
        ...
        case PULL_To_REFRESH:
            ...
            System.out.println("harry --- setOnRefreshListener-PULL_To_REFRESH-");
            //Log.v(TAG, "当前状态，下拉刷新");  
            break;  
        ...
        case DONE:  
            ...
            tipsTextview.setText(R.string.pull_to_refresh_pull_label);  
            lastUpdatedTextView.setVisibility(View.VISIBLE);  
            System.out.println("harry --- setOnRefreshListener-DONE-");
            //Log.v(TAG, "当前状态，done");  
            break;  
        }  
    }  
    ...
    public void clickRefresh() {
    	System.out.println("harry --- clickRefresh---");
    	setSelection(0);
    	state = REFRESHING;  
        changeHeaderViewByState();  
        onRefresh(); 
    ...
    public void setOnRefreshListener(OnRefreshListener refreshListener) {  
    	System.out.println("harry --- setOnRefreshListener---");
    ...
    public void onRefreshComplete() {  
    	System.out.println("harry --- onRefreshComplete---");
        state = DONE;  
        changeHeaderViewByState();  
    }  
