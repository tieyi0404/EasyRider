...
public class FragmentTabManager implements TabHost.OnTabChangeListener {
	...
	public FragmentTabManager(FragmentActivity activity, TabHost tabHost,
			int containerId) {
		mActivity = activity;
		mTabHost = tabHost;
		...
		if (mLastTab != newTab) {
			...
			if (mLastTab != null) {
				if (mLastTab.fragment != null) {
					onFragmentHide(ft, mLastTab.fragment);
...
//					ft.attach(newTab.fragment);
					onFragmentShow(ft, newTab.fragment);
				}
			}
	...
	public void onFragmentShow(FragmentTransaction fragmentTransaction,
			Fragment fragment) {
	}

	public void onFragmentHide(FragmentTransaction fragmentTransaction,
			Fragment fragment) {
	}
}
