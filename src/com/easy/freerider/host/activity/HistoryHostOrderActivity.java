...
public final class HistoryHostOrderActivity extends FragmentActivity  implements XListView.IXListViewListener {
	...
	private Handler mHandler = new Handler() {
		public void handleMessage(android.os.Message msg) {
				...
				if((msg.arg1 == 2) || (msg.arg1 == 1)) // means JSONObject array
				{
					...
					try {
						if (object.getInt("Code") == 200) {     
		    			    ...
		    			    Toast.makeText(HistoryHostOrderActivity.this, 
			...
			case RWSFAIL:
				refreshList(null);
				Toast.makeText(HistoryHostOrderActivity.this, "数据更新出现错误，请稍后重试", Toast.LENGTH_SHORT)
						.show();
				break;
			default:
				break;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mListView = (XListView) findViewById(R.id.xlist_view_host_order_his);
		if (taskAdapter == null) {
			Log.d(TAG, "taskAdapter is null");
			taskAdapter = new HostRouteListAdapter(this,R.layout.host_route_item, hostTaskList);
		}
		initView(mListView);
	  ...
	  private void initView(View v) {
	        mListView = (XListView) v.findViewById(R.id.xlist_view_host_order_his);
	        ...
	        mListView.setOnItemClickListener(new OnItemClickListener(){
				...
				public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					...
					Intent i = new Intent(HistoryHostOrderActivity.this, HostRouteDetailActivity.class);
	...
	public void hostRouteQueryTask(int refreshIndex){
		try{
			...
			request.getHostRouteHistoryReq(user.getMobile(),refreshIndex);
		}catch (Exception e) {
