...
public final class HistoryGuestOrderActivity extends FragmentActivity  implements XListView.IXListViewListener {
	private final int RESPSUCESS = 1;
	private final int RWSFAIL= 2;
	private TextView detail_title;
	private TextView detail_Back;
	private String d_title_s;
	private static final String TAG = HistoryGuestOrderActivity.class.getSimpleName();
	...
	private Handler mHandler = new Handler() {
		public void handleMessage(android.os.Message msg) {
				...
				if((msg.arg1 == 2) || (msg.arg1 == 1)) // means JSONObject array
				{
					...
					try {
						if (object.getInt("Code") == 200) {     
		    			    ...
		    			    Toast.makeText(HistoryGuestOrderActivity.this, 
			...
			case RWSFAIL:
				refreshList(null);
				Toast.makeText(HistoryGuestOrderActivity.this, "数据更新出现错误，请稍后重试", Toast.LENGTH_SHORT)
						.show();
				break;
			default:
				break;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mListView = (XListView) findViewById(R.id.xlist_view_guest_hist_order);
		if (taskAdapter == null) {
	...
	private void initView(View v) {
        mListView = (XListView) v.findViewById(R.id.xlist_view_guest_hist_order);
        ...
        mListView.setOnItemClickListener(new OnItemClickListener(){
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Intent i = new Intent(HistoryGuestOrderActivity.this, GuestRouteDetailActivity.class);
	...
	public void hostRouteQueryTask(int refreshIndex){
		try{
			...
			request.getGuestRouteHistoryReq(user.getMobile(),refreshIndex);
		}catch (Exception e) {
			e.printStackTrace();
		}
	}
